...
const MODELS: Model[] = [
    ...
    {
        path: `${MODEL_FOLDER}/1/01b1.gltf`,
        type: 'floor',
        name: '01b1',
        displayName: '4124763-4-B1',
    },
    {
        path: `${MODEL_FOLDER}/2/02g.gltf`,
        type: 'floor',
        name: '02g',
        displayName: '4124763-4-G',
    },
    {
        path: `${MODEL_FOLDER}/3/03.gltf`,
        type: 'floor',
        name: '03',
        displayName: '4124763-4-F01',
    },
    {
        path: `${MODEL_FOLDER}/4/04f.gltf`,
        type: 'floor',
        name: '04f',
        displayName: '4124763-4-F02',
    },
    {
        path: `${MODEL_FOLDER}/5/05f.gltf`,
        type: 'floor',
        name: '05f',
        displayName: '4124763-4-F03',
    },
    {
        path: `${MODEL_FOLDER}/6/06f.gltf`,
        type: 'floor',
        name: '06f',
        displayName: '4124763-4-F04',
    },
    {
        path: `${MODEL_FOLDER}/7/07f.gltf`,
        type: 'floor',
        name: '07f',
        displayName: '4124763-4-F05',
    },
    {
        path: `${MODEL_FOLDER}/8/08f.gltf`,
        type: 'floor',
        name: '08f',
        displayName: '4124763-4-F06',
    },
    {
        path: `${MODEL_FOLDER}/9/09r1.gltf`,
        type: 'floor',
        name: '09r1',
        displayName: '4124763-4-R1',
    },
    {
        path: `${MODEL_FOLDER}/10/10r2.gltf`,
        type: 'floor',
        name: '10r2',
